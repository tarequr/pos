...
<div class="container-fluid p-0">
    <div class="mb-3">
        <h1 class="h3 d-inline align-middle">Sold Products</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Sold Product List</h5>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">No sold products found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
